            ...
            <form className='w3-container w3-padding w3-dark-gray w3-round-large' onSubmit={this.props.submitHandler}>
                <div className="w3-panel">
                    <div className='w3-group w3-margin-bottom'>
                        ...
                        <input placeholder="Your name here" minLength="6" maxLength="19" className="w3-input" type="text" name="name" required />
                    </div>
                    <div className='w3-group w3-margin-bottom'>
                        <label className='w3-label'>Short Description of yourself</label>
                        <input placeholder="Tell us about yourself" maxLength="99" className="w3-input" type="text" name="about" />
                    </div>
                    <div className='w3-group w3-margin-bottom'>
                        <label className='w3-label'>Message *</label>
                        <textarea placeholder="Your message" minLength="16" maxLength="499" className="w3-input" type="text" style={{ height: '150px' }} name="message" required />
                    </div>
                    ...
                    <div className='w3-group w3-margin-bottom'>
                        ...
                        <input placeholder="Your email here. It won't be shown to others." className="w3-input" type="text" name="email" />
                    </div>
                </div>
